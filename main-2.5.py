# Version: 2.5
# Release date: 11.11.2022 (dd/mm/yyyy)
...
def get_ping():
    ...
    try:
        with open(f"server_best.txt", 'w') as file:
...
def disclaimer_msg():
    ...
    try:
        accepted = askyesno("OTO - Disclaimer",
                            "OT-Optimizer (OTO) is a free-to-use software/program/tool which changes system & network settings to optimizer your gaming performance.\n"
                            "By using this program, you agree that you are liable for any damage.\n"
                            ...
                            "We cannot quarantee you that this tool will actually improve your ping, FPS and general performance."
...
def main_menu():
    ...
    if choice == "1":
        ...
        if yeono == True and best_server_txt:
