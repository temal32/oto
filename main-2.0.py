# Version: 2.0
# Release date: 01.08.2022 (dd/mm/yyyy)
version = 2.0
...
def show_menu():
    ...
    menu_contact = colored(" - Temal#5222 - ItzOwo#1414 - Danilo#0001 - Aetopia#1180", color="cyan")
    menu_dc = colored("\nwww.discord.gg/RMQcevDWng", color="blue")
    ...
    try:
        ...
        if float(data) > float(version):
            ...
            try:
                ...
                print(colored("ERROR: Could not download update.", "red"))
                input_exit()
            sleep(2)
            global loading_done
            loading_done = True
