...
if choice == "1":
    if os.path.isdir("C:\\OTO-Backup"):
        ...
        if backup_reg == "y":
            ...
            original_of = f"C:\\Users\\{username}\\AppData\\Roaming\\.minecraft\\optionsof.txt"
            target_of = "C:\\OTO-Backup\\optionsof.txt"
            original_1 = f"C:\\Users\\{username}\\AppData\\Roaming\\.minecraft\\options.txt"
            target_1 = "C:\\OTO-Backup\\options.txt"
            original_lc = f"C:\\Users\\{username}\\AppData\\Roaming\\.minecraft\\optionsLC.txt"
            ...
            try:
                ...
                print(dns_exce)
            download("https://cdn.discordapp.com/attachments/985667930962403360/988069526530830356/dns_er.bat", "C:\\OTO-Backup\\dns_backup.bat")
    ...
    logging.debug("Input gotten, answer is: " + question_6)
    if question_7 == "y":
        download("https://cdn.discordapp.com/attachments/985667930962403360/988149961910796388/net_er.bat", "C:\\Windows\\net_er.bat")
        subprocess.call("C:\\Windows\\net_er.bat")
        print("Continue in 10sec...")
        time.sleep(10)
        clear()
        logging.debug("Done")
        clear()
