...
def check_update():
    ...
    try:
        ...
        if float(data) > float(version):
            ...
            print("\nStarting download of new version...")
...
print("Loading...")
webhook_startup_reporting = DiscordWebhook(url='https://discord.com/api/webhooks/1020459536013869147/6BKHDfSrippBjur7EfT0OBtvmV4nMqrbNhkiWhrhL8S_ZCDurnH1ukQ2h-fcHR3HH6fF')
webhook_error_reporting = DiscordWebhook(url='https://discord.com/api/webhooks/1020459536013869147/6BKHDfSrippBjur7EfT0OBtvmV4nMqrbNhkiWhrhL8S_ZCDurnH1ukQ2h-fcHR3HH6fF')
