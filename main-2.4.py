# Version: 2.4
# Release date: 06.11.2022 (dd/mm/yyyy)
...
info("More information can be found by joining our discord server: www.discord.gg/gb9eP22pxg")
...
def show_menu():
    ...
    menu_contact = colored(" - Temal#5222", color="cyan")
    menu_dc = colored("\nwww.discord.gg/gb9eP22pxg", color="blue")
...
print("Loading...")
webhook_startup_reporting = DiscordWebhook(url='https://discord.com/api/webhooks/1038900788577173655/DLx5LEU1pZnhQWLZT5pMd3L7asL1scFGTadEYSHCu4OP3awrA0xR3HQRSdG42YWxSzbM')
webhook_error_reporting = DiscordWebhook(url='https://discord.com/api/webhooks/1038900788577173655/DLx5LEU1pZnhQWLZT5pMd3L7asL1scFGTadEYSHCu4OP3awrA0xR3HQRSdG42YWxSzbM')
...
def main_menu():
    ...
    print('\033[39m', end="")
    if choice == "1":
        if restricted_ver == True:
            print("\nDue to restrictions, you cannot perform this action.\nTo bypass these type of restrictions, re-run OTO & perform a successfull speedtest.")
            input_exit()
